...
# Function to simulate small chunk data extraction
def simulate_small_chunk_extraction():
    # Simulating small chunk data extraction
    time.sleep(3)  # Simulating 3 seconds of small chunk data extraction
...
def plot_cpu_utilization(cpu_data, timestamps):
    ...
    plt.title('CPU Utilization Over Time - Small Chunk Extraction')
    plt.xlabel('Time')
...
# Main function to collect and plot CPU utilization for small chunk extraction case
def main_small_chunk_extraction():
    ...
    # Start small chunk data extraction simulation
    simulate_small_chunk_extraction()
